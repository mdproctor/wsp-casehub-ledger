...
| Concurrent sequence/Merkle race | Concurrent saves corrupt chain silently | `LedgerSequenceAllocator` INSERT ON CONFLICT + UPDATE; `InMemoryLedgerEntryRepository` per-subject lock (issue #100) |
